export const defaultStringsEn = {
  translation: {
    narrat: {
      ...
      game_menu: {
        ...
        achievements: {
          ...
          hidden_description:
            'This achievement is hidden. Complete it to discover more.',
    ...
    quests: {
      categories: {
        category_2: 'Quest Category 2',
      },
      bread_shopping: {
        title: 'Bread Shopping',
        description: 'The cat asks you to buy bread for it.',
        objectives: {
          bread: {
            description: 'Buy bread for the cat.',
          },
          delivery: {
            description: 'Deliver the bread to the cat.',
          },
        },
      },
    },
    items: {
      ...
      book: {
        name: 'Sinister Book',
        description: 'A sinister-looking book',
      },
    },
  },
};
