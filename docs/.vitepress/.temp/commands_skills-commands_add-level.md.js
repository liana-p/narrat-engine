...
const __pageData = JSON.parse('{"title":"Add Level","description":"The add_level function in narrat increases the level of the player in a specified skill","frontmatter":{"description":"The add_level function in narrat increases the level of the player in a specified skill"},"headers":[],"relativePath":"commands/skills-commands/add-level.md","filePath":"commands/skills-commands/add-level.md","lastUpdated":1687862260000}');
const _sfc_main = { name: "commands/skills-commands/add-level.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="add-level" tabindex="-1">Add Level <a class="header-anchor" href="#add-level" aria-label="Permalink to &quot;Add Level&quot;">​</a></h1><p>The add_level function in narrat increases the level of the player in a specified skill</p><p>Syntax: <code>add_level [skillId] [amountOfLevels]</code></p><p>See the <a href="./../../features/skills.html">skills system guide</a> to know more</p><p>Example:</p><div class="language-narrat vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">narrat</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#6F42C1", "--shiki-dark": "#B392F0" })}">skillCheckChoice</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">:</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#D73A49", "--shiki-dark": "#F97583" })}">        add_level</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}"> agility </span><span style="${ssrRenderStyle({ "--shiki-light": "#005CC5", "--shiki-dark": "#79B8FF" })}">1</span></span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("commands/skills-commands/add-level.md");
