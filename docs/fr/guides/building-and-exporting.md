...
Lorsque vous exécuterez la commande `pnpm run build`, celle-ci génèrera un dossier `dist` contenant une version web de votre jeu. Vous pourrez créer une archive .zip de ce dossier et l'uploader sur itch.io comme jeu web ; il sera alors jouable directement sur sa page.
